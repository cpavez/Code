...
Route::get('epiEvolucionKine', 'EpisodioController@evolucionKine');
...
Route::get('epiEncuesta', array('as'=>'epiEncuesta','uses'=>'EpisodioController@encuesta'));
...
Route::get('epiAnamnesisKine', 'EpisodioController@epiAnamnesisKine');
Route::get('epiSignosVitales', 'EpisodioController@epiSignosVitales');
Route::get('epiFotos', 'EpisodioController@epiFotos');
Route::get('epiAnamnesisPediatrica', 'EpisodioController@epiAnamnesisPediatrica');
Route::get('epiPerinatales', 'EpisodioController@epiPerinatales');
Route::get('epiPrestaciones', array('as'=>'epiPrestaciones','uses'=>'EpisodioController@prestaciones'));
Route::get('imprimirInforme', array('as'=>'imprimirInforme','uses'=>'EpisodioController@imprimirInforme'));
Route::get('epiInforme', 'EpisodioController@epiInforme');

Route::post('agregarEpisodio', 'EpisodioController@agregar');
Route::post('agregarEvolucion', 'EpisodioController@agregarEvolicion');
Route::post('agregarInforme', 'EpisodioController@agregarInforme');
Route::post('agregarEvolucionKine', 'EpisodioController@agregarEvolucionKine');
...
Route::post('agregarEpiPerinatales', 'EpisodioController@agregarEpiPerinatales');
Route::post('guardarAnamnesisPediatrica', 'EpisodioController@guardarAnamnesisPediatrica');
Route::post('guardarFuerzaMotora', 'EpisodioController@guardarFuerzaMotora');
Route::post('guardarPerimetro', 'EpisodioController@guardarPerimetro');
Route::post('guardarAngulo', 'EpisodioController@guardarAngulo');
Route::post('guardarGoniometria', 'EpisodioController@guardarGoniometria');
...
Route::post('eliminarEpisodio', 'EpisodioController@eliminarEpisodio');
...
Route::post('agregarPrestacionOdontograma', 'OdontogramaController@agregarPrestacionOdontograma');
Route::post('listarOdontograma', 'OdontogramaController@listarOdontograma');
Route::get('listarPrestacionOdontograma', 'OdontogramaController@listarPrestacionOdontograma');
Route::post('eliminarPrestacionOdontograma', 'OdontogramaController@eliminarPrestacionOdontograma');
...
Route::get('ufro', 'UfroController@indexUfro');
