...
<div class="col-lg-10 contenedor conenedor_mod">
	<div id='contenidoReportes' class="bs_timeline_rigth" style="margin-top: 0px;border: 1px solid #D6D6D6;position: absolute;right: 0;left: 0;top: 0;bottom: 0;">
    </div>
</div>
...
<script>
	$("#menu_reportes > li").click(function(){
		...
		if(this.id){
			...
			$("#contenidoReportes").load(this.id+'?esb_id='+esb_id);
