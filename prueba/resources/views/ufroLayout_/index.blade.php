...
<!--<link href="{{ asset('css/base.css') }}" rel="stylesheet">
    ...
    <style>
        ...
        .paypal .left input[type=checkbox], .credit .left input[type=checkbox] {
            visibility: hidden;
        }
        ...
        .more-slider-input-range {
            padding-top: 0;
            padding-bottom: 0;
            border-bottom-width: 0;
        }

        .more-slider-input-range input[type=range] {
            margin: 0;
        }
        ...
        .range input {
            ...
            height: 45px;
            outline: 0;
            background: -webkit-gradient(linear,50% 0,50% 100%,color-stop(0,#ccc),color-stop(100%,#ccc)) center no-repeat;
            background: linear-gradient(to right,#ccc 0,#ccc 100%) center no-repeat;
