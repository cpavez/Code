...
<div class="label-primary" style="height: 35px;width: 100%;line-height: 35px;color: #fff;padding-left: 10px;">Devoluciones</div>
<div style="position: absolute;top: 35px;bottom: 0;left: 0;right: 0;overflow-y: scroll;">
    <div class="row" style="margin:20px 10px;">
        ...
        <div class="col-xs-2">
            <span></span>
            <button type="button" class="btn btn-success" id='buscarDevoluciones' style="margin-top:19px;">Buscar</button>
        </div>
    </div>
...
<script>
    ...
    $("#buscarDevoluciones").click(function(){
        ...
        $("#contenidoCaja").load('repDevoluciones?esb_id='+esb_id+'&fechaDesde='+fechaDesde+'&fechaHasta='+fechaHasta);
    });
</script>